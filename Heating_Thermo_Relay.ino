...
//Time Counter
float count = 0; //counter of data points
float prev_time = 0; //previous time
float new_time = 0;
void setup() {
  // setup - LCD
...
void loop() {
  ...
  if (new_time - prev_time >= 10000 && count < 360){ // check for time passed and if you're still within the hour
    new_time = millis(); // take new time reading
   // here take the readings or data
